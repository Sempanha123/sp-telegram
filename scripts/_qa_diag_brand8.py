"""Test: does header transparency break child QLabel QSS background?"""
import sys
...
def test(name, header_bg):
    qss = f"""
QWidget {{ background: #070A11; }}
QFrame#sidebar {{ background: #04060A; }}
QFrame#sidebar QFrame {{ background: {header_bg}; }}
...
test("header SOLID #04060A", "#04060A")
test("header TRANSPARENT", "transparent")