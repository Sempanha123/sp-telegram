...
class ToastNotification(QFrame):
    ...
    def show_message(self,message:str,level:str="Info",timeout_ms:int=3500)->None:
        level=str(level or "Info").title(); icon_name={"Success":"check","Warning":"warning","Error":"warning"}.get(level,"info"); self.lbl_icon.setPixmap(IconManager.get(icon_name).pixmap(20,20)); self.lbl_title.setText(level); self.lbl_description.setText(message)
