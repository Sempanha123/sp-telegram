...
class GroupsPage(BaseTablePage):
    ...
    def __init__(self,controller,parent=None,*,avatar_service=None):
        ...
        # Add Group already accepts usernames, links, invite tokens and IDs.
        # Keep the historical object for compatibility, but do not show the
        # duplicate Resolve Group action in the production header.
        self.action_buttons["btn_add_group"].setToolTip("Add or resolve a Telegram group from a username, link, invite or ID")
        self.action_buttons["btn_resolve_group"].hide()
        self.actions={}
