...
class MembersPage(BaseTablePage):
    ...
    def show_more(self):
        menu=QMenu(self);menu.addAction(self.act_member_details);menu.addAction(self.act_member_export);menu.addSeparator();menu.addAction(self.act_member_mass_add);menu.addAction("Manage Tags",lambda:MemberTagManagerDialog(self.controller,None,self).exec());elig=menu.addMenu("Eligibility");elig.addActions([self.act_member_mark_eligible,self.act_member_manual_review]);excl=menu.addMenu("Blacklist / Do Not Contact");excl.addActions([self.act_member_global_blacklist,self.act_member_do_not_contact,self.act_member_remove_exclusion]);menu.addSeparator();menu.addAction(self.act_member_remove_selected);menu.addAction(self.act_member_clear_filtered);menu.addAction(self.act_member_clear_source);menu.addAction(self.act_member_clear_orphaned);menu.addAction(self.act_member_clear_all);menu.addSeparator();menu.addAction(self.act_member_reset_table);menu.exec(self.action_buttons["btn_member_more"].mapToGlobal(self.action_buttons["btn_member_more"].rect().bottomLeft()))
